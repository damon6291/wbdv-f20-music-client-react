...
const PostGenerator = () =>
    <div style={{border:"solid", borderRadius:"10px"}}>
        ...
        <div className="row" style={{marginLeft:"20px", padding:"5px"}}>
            <img style={{height:"50px", borderRadius:"10px"}} src="https://4.bp.blogspot.com/-L9CtV6gR8GI/WtgKA619aEI/AAAAAAAAF9c/CubtyZE94o076qCShJN_D2bdNiHoeIRxACEwYBhgL/s320/cool%2Bprofile%2Bimages.png"/>
            <div className="col">
